...
class GetSpace
{
    ...
    public function asController(int $space_id, Request $request)
    {
        $token = env('CU_TOKEN');//$request->get('token');
        return $this->handle($token, $space_id);
    }
